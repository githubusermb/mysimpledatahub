...
def register_table_with_lake_formation(catalog_id, database_name, table_name, bucket, prefix):
...
if not table_exists:
    ...
    try:
        ...
        register_table_with_lake_formation(catalog_id, database_name, table_name, iceberg_data_bucket, iceberg_data_prefix)
    except Exception as e:
